...
function YourProfile({ user, profileMetadata }) {
  ...
  return (
    <div className="space-y-6 animate-fadeIn">
      ...
      <div className="bg-[#1e293b] rounded-2xl p-6 border border-[#334155] shadow-xl relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-5 pt-2">
          ...
          <div className="text-center sm:text-left space-y-1">
            ...
            <div className="flex gap-4 pt-3 text-xs justify-center sm:justify-start">
      ...
      <div className="space-y-4">
        {loading ? (
          ...
          myPosts.map((post) => (
            <div key={post.id} className="bg-[#1e293b] rounded-xl p-5 border border-[#334155] shadow-md">
              <p className="text-sm text-slate-200 leading-relaxed whitespace-pre-wrap">{post.caption}</p>
              <div className="flex justify-between items-center border-t border-[#334155]/30 mt-4 pt-3 text-xs text-slate-400">
